...
export const HeroMain = () => {
  return (
    <section className="container px-4 mx-auto max-w-[1200px] my-8">
        <div className="flex flex-col justify-center relative space-y-6 md:flex-row md:items-center lg:gap-8">
            <img className="block translate-x-8  md:order-2 md:w-1/2" src="/images/illustration-working.svg" alt="lustracion hero" />
